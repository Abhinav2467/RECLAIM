  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] text-stone-900 flex flex-col font-sans antialiased">
      ...
      <main className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* Tab Rendering: Operations Console vs Case Detail Experience */}
        {activeTab === "operations" ? (
          ...
          <div className="space-y-6 animate-in fade-in duration-200">
            ...
            {caseData ? (
              ...
              <div className="p-12 text-center bg-white rounded-xl border border-stone-200 font-mono text-xs text-stone-500">
                No recovery case selected. Select a case from the operations queue.
              </div>
            )}
          </div>
        ) : null}
